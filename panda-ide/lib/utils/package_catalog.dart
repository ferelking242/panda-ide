...
class PackageCatalogService {
  static final List<RunTime> _pfdRuntimes = [
    RunTime(
      ...
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/python.zip',
    ...
    RunTime(
      ...
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/node.zip',
    ...
    RunTime(
      ...
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/clang.zip',
    ...
    RunTime(
      ...
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/java-21-openjdk.zip',
    ...
    RunTime(
      ...
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/kotlin.zip',
    ...
    RunTime(
      ...
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/dart.zip',
    ...
    RunTime(
      ...
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/ruby.zip',
    ...
    RunTime(
      ...
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/rust.zip',
    ...
    RunTime(
      ...
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/go.zip',
      archiveName: 'go.zip',
      archiveSize: 51,
      parentName: 'go',
    ...
    RunTime(
      ...
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/lua.zip',
      archiveName: 'lua.zip',
      archiveSize: 1,
      parentName: 'lua',
  ...
  static final List<Extension> _pfdExtensions = [
    Extension(
      ...
      archiveSize: 12,
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/copilot-language-server.zip',
      fileExtension: const [],
      serverFile: const [
    ...
    Extension(
      ...
      archiveSize: 4,
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/bash-language-server.zip',
    ...
    Extension(
      ...
      archiveSize: 14,
      url: 'https://github.com/ferelking242/panda-binaries/releases/download/v1.0.0/vscode-langservers-extracted.zip',
