...
List<PaletteCommand> builtinCommands() => [
  ...
  const PaletteCommand(id: 'git.diff', label: 'Git: View Changes', category: 'Git', icon: Icons.compare_arrows),
  ...
  const PaletteCommand(id: 'editor.symbols', label: 'Go to Symbol', category: 'Editor', icon: Icons.label, aliases: ['Ctrl+Shift+O']),
