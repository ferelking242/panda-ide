...
class _SpinningSquareIndicator extends StatefulWidget {
  final Color color;
  final double size;

  const _SpinningSquareIndicator({
    this.color = const Color(0xff9c27b0),
    this.size = 11,
  });

  @override
  State<_SpinningSquareIndicator> createState() => _SpinningSquareIndicatorState();
}

class _SpinningSquareIndicatorState extends State<_SpinningSquareIndicator>
    with SingleTickerProviderStateMixin {
  late AnimationController _ctrl;
  late Animation<double> _spin;
