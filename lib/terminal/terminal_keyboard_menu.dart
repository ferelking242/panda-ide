                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        ...
                        shortcutChip('CtrlC', '\x03'),
                        shortcutChip('CtrlZ', '\x1a'),
                        shortcutChip('CtrlD', '\x04'),
                        shortcutChip('CtrlL', '\x0c'),
                        shortcutChip('CtrlA', '\x01'),
                        shortcutChip('CtrlE', '\x05'),
                        shortcutChip('CtrlK', '\x0b'),
                        shortcutChip('CtrlU', '\x15'),
                        shortcutChip('CtrlW', '\x17'),
                      ],
                    ),
                  ),
