...
const List<AgenticToolSpec> agenticToolSpecs = [
  ...
  AgenticToolSpec(
    name: 'openFile',
    label: 'Open file',
    description: 'Opens a workspace file in the current editor context and returns its contents.',
    requiresWriteAccess: false,
  ),
  AgenticToolSpec(
    name: 'deleteFile',
  ...
  AgenticToolSpec(
    name: 'getSecret',
    label: 'Get configured secret',
    description: 'Reads one configured secret by name without exposing secret values in the tool catalog.',
    requiresWriteAccess: false,
  ),
  AgenticToolSpec(
    name: 'listSecrets',
    label: 'List configured secrets',
    description: 'Lists the names of secrets available to the agent.',
    requiresWriteAccess: false,
  ),
  AgenticToolSpec(
    name: 'getAgentSkills',
    label: 'List agent skills',
    description: 'Lists the reusable skills available to the agent.',
    requiresWriteAccess: false,
  ),
  AgenticToolSpec(
    name: 'useAgentSkill',
    label: 'Load agent skill',
    description: 'Loads instructions for a named reusable agent skill.',
    requiresWriteAccess: false,
  ),
  AgenticToolSpec(
